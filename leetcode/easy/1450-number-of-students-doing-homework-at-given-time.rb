# ruby leetcode/easy/1450-number-of-students-doing-homework-at-given-time.rb
...
def busy_student(start_time, end_time, query_time)
  ...
  (0..start_time.size - 1).each do |index|
    num_students += 1 if query_time >= start_time[index] && query_time <= end_time[index]
  end

  num_students
end

p busy_student([9,8,7,6,5,4,3,2,1], [10,10,10,10,10,10,10,10,10], 5)
