# ruby leetcode/easy/492-construct-the-rectangle.rb

# For a web developer, it is very important to know how to design a web page's size. So, given a specific 
# rectangular web page’s area, your job by now is to design a rectangular web page, whose 
...
def construct_rectangle(area)
  possible_answer = [area, 1]
  
  (1..Math.sqrt(area)).each do |width|
    if area % width == 0
      possible_answer = [area / width, width]
    end
  end
