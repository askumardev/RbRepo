# ruby leetcode/easy/278-first-bad-version.rb
...
# following ones to be bad.# You are given an API bool isBadVersion(version) which will return whether version is bad.
