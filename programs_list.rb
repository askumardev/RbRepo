...
# Identify loop/cycle in a LinkedList.
# Find length of a loop in a LinkedList.
# Detect and remove loop in a LinkedList.
# How to reverse Singly Linked List?
# Check if given Linked List is a Circular Linked List or not.
...
# HackerRank stack problem - Find maximum element.
# HackerRank stack problem - Balanced Brackets.
# HackerRank stack problem - Equal Stacks.
